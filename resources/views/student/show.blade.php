...
<nav class="mb-4">
    <ol class="flex items-center space-x-2 text-sm">
        ...
        <li class="font-medium text-gray-700">User details</li>
    </ol>
</nav>

<div class="bg-white shadow-lg rounded-lg p-6">
    <div class="flex justify-between mb-5">
        <h1 class="text-3xl font-bold text-center text-gray-800">{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }}</h1>
