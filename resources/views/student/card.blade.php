<div class="max-w-md w-full bg-white rounded-lg shadow-lg mb-6 mx-auto min-w-90">
    ...
    <div class="px-3 py-4 flex space-x-2 border-t border-gray-200 flex justify-center">
        <button
        ...
        <button
            class="inline-block p-2 bg-green-100 text-green-500 hover:bg-green-200 hover:text-green-700 rounded transition-colors"
            title="View user">
